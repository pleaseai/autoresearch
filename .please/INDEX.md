...
| Document                                   | Purpose                                                                           |
| ------------------------------------------ | --------------------------------------------------------------------------------- |
| [`../ARCHITECTURE.md`](../ARCHITECTURE.md) | Repository-level bird's-eye view (create with `/standards:architecture-md write`) |
| [`../docs/adr/`](../docs/adr/)             | Architecture Decision Records (create with `/standards:adr`)                      |
